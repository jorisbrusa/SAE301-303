...
d3.dsv(',', '../CSV/data.csv')
    .then(cleanedData => {
        ...
        // Filtrer les données pour "BioREco"
        const projectData = cleanedData.filter(row => row['Nom du projet']?.trim() === 'BioREco');
        console.log("Données filtrées pour BioREco :", projectData);
        ...
        new Chart(document.getElementById('chart1_2').getContext('2d'), {
            type: 'pie',
            data: {
        ...
        new Chart(document.getElementById('chart2_2').getContext('2d'), {
            type: 'bar',
            data: {
                labels: methodLabels,
                datasets: datasets,
        ...
        new Chart(document.getElementById('chart3_2').getContext('2d'), {
            type: 'doughnut',
            data: {
